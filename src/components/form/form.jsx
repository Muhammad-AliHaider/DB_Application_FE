   ...
   return(
    ...
    <Box className = {style.boxClass}>
        <Grid container spacing={2}>
            ...
            { props.tabActive === 2 ?
            <Grid item xs={12} sm={12}>
                <TextField value = {props.Field6} onChange={(e)=>{props.handleField6(e.target.value)}} className = {style.textFieldClass} variant="filled" label = {props.TableFields.columns[2]}/>
            </Grid> : <></>
            }
        </Grid>
    </Box>
